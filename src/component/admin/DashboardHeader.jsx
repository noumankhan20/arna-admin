        ...
        <header className="h-24 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-10 sticky top-0 z-40 transition-all duration-300">
            <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                    ...
                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest leading-none text-nowrap">Real-time shop performance</p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="flex items-center gap-4 p-1.5 pr-4 rounded-2xl hover:bg-gray-50 transition-all group border border-transparent hover:border-gray-100">
                        <div className="w-10 h-10 bg-emerald-600 rounded-xl flex items-center justify-center text-white font-black shadow-lg shadow-emerald-200 group-hover:scale-105 transition-transform">
                            {adminName.charAt(0).toUpperCase()}
                        </div>
                        <div className="text-left hidden lg:block">
                            <p className="text-[11px] font-black text-gray-900 leading-tight group-hover:text-emerald-700 transition-colors uppercase tracking-tight">{adminName}</p>
                            <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Primary Operator</p>
                        </div>
                    </button>
                </div>
            </div>
